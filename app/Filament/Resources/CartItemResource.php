...
class CartItemResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Sepet Öğeleri';
    
    protected static ?string $modelLabel = 'Sepet Öğesi';
    
    protected static ?string $pluralModelLabel = 'Sepet Öğeleri';
